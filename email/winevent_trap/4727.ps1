...
'[{0:yyyyMMdd--hh:mm:ss}] {1}' -f [datetime]::Now,'Group membership change - AD group created' | Out-file c:\xiss\events.log -append
$p=@{
...
$subject='[{0:yyyyMMdd--hh:mm:ss}] {1}' -f [datetime]::Now,'AD Group membership change - AD group created'
